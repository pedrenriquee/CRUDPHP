...
<html lang="pt-br">
  <head>
    ...
    <!--pesquisar nos outros codigos a necessidade desse title senão alterar para outro nome -->     
  ...
  <body>
    <div class="contanier">
        <div class="row">
            <div class="col">
                <div class="jumbotron">
                    <h1 class="display-4">Projeto 01 CRUD</h1>
                    <p class="lead">Esse é o meu primeiro crud com php e bootstrap!</p>
                    <hr class="my-4">
